...
已实际看图并阅读全文。Harry Kane红黑比赛表现卡与比分；prompt需另行检索当周赛事资料，图为结果卡，本次未验证比分和实时资料。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：钢琴演奏、直播标识及右侧聊天栏的YouTube画面。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
YouTube 双人直播截图，聊天侧栏和 SARDI 背景与文本场景对应。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
蓝发动漫人物与金色初配信大字的直播封面。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。银发猫耳角色、粉色手机及韩文直播评论封面；UI和人物均为JSON要求的输出元素。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：OpenAI讲演与GPT-Image-2演示的YouTube界面样机。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
游戏主播与麦克风、后方游戏屏及弹幕，短 prompt 直接描述直播。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
原图为Arena对比界面，两张女性游戏直播输出，上方请求文本；界面还显示不同模型名称。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。绿发猫耳角色与账单信封、100连开封标题；文本给出视频主题，无指定角色照片。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：中央人物、岛屿、红线与档案夹的纪录片封面。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
黄金圣斗士十二格卡片，人物卡片是成品输出。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
长黑发女战士挥舞金属链刃的动漫战斗画面。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。四格黑白讽刺采访漫画与对白；文本完整指定叙事及字句，本次只核图文类型，不核人物指控。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：城市克隆人群和分格对话的黑白漫画跨页。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
黑白漫画跨页，左侧制作游戏分镜与右侧施法大格可见。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
牛油果对汤匙咨询师诉说空虚的拟人场景。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。黑底白发西装老人握武士刀；详细文字给出人物和构图，无附图条件。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：外星巨构电影海报及人物、道具和场景设定小图。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
金发少女蹲姿破玻璃施法，紫色法阵和哥特城景可见。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
未来公司大厅、女性耳机近景和离场的三格漫画。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。外星人列车、饭团恋爱、老人钞票和洗衣风暴四海报；完整JSON定义各格。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：武士人物立绘、三视图、表情与装备说明。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
四位女孩户外烧烤动画海报，烤肉前景与烟熏炉明确。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
紫发动漫女孩、定位孔及边缘原画批注的制作纸画面。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。红发男性与戴白帽女性的动漫小说封面；外貌、姿势及标题文本完整。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
