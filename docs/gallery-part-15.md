...
实际查看LOG AI五款标志概念及应用样机的展示板。归档有五组完整品牌设计指令，含业务信息占位符，样图展示其中标志概念的结果；品牌文本为使用时填写项，未要求指定原图片。
...
Phoenix Rebirth 概念字形与凤凰火焰海报，输入文字明确。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
女性坐于自己的巨型头部上，背景有OVERTHINKING与MIND文案。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。圆镜鱼眼咖啡馆男性喝青色杯饮品；\[your photo as reference\]是通用替换照片槽，复用时需提供自己的照片，但未指向一张必须归档的指定原图。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：橙底运动女性、草莓和能量饮料罐广告。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
水墨大头像与下方全身球员双重曝光海报，SUBJECT 为通用主题槽。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
男性长发主头像及多种发型的分析卡；same face指板内一致，similar layout未指定独立源图。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。iPhone部件爆炸板；subject/object为通用对象参数，没有特定产品图要求。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：MATCHA MODE抹茶杯、纸袋、瓶和菜单视觉板。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
人物色彩档案含主肖像、服装色卡和穿搭图；自用需提供主体或照片，prompt 未指定某张缺失原图。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
四位科学家收藏玩具、配件与包装的四格发布板。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。户外咖啡馆卷发女性与咖啡2D涂鸦；文字逐项描述真实场景和叠加元素。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：金色香水瓶、女性肖像与VELORA字样广告。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
原文指向真实菜单，但只明示 beef roast；现存为成品宣传页，不含原菜单。换用自己的菜单可复用，原菜单文字细节未归档。 审核只涉及资料输入要求/资产角色，不包含重新生图、身份一致性或像素复现验证。
...
明洞区域旅游地图，地点是模板文本条件。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
褶皱纸团到椅子形态、工程视图及成品的概念研发板；image of crumpled paper描述观察对象，未指定上传来源。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。PRIME STEAK黑金品牌与肉排主视觉；商品名称、品牌等为必填文本槽，不是缺图片。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：古希腊街景中三位哲人及上方时间轴文字。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
地砖上绿色饮料泼洒、倒杯与人影，完整写实输出。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
原图只有真人宴席肖像及Is ChatGPT Image 2 really THAT good宣传文字，未见prompt要求的3D收藏玩具结果。该图更像宣传封面或原照片展示，无法确认输入/输出身份；尚缺明确的对应结果，保留待复核。
