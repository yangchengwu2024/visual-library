...
实际查看：送货员来访情节与女性立绘组成的彩色漫画页。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
夜色树屋餐厅、儿童和拟人动物电影海报。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
绿发猫耳角色和日文书名的水彩书封。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。粉色动漫角色品牌和周边综合展示；头像、包装、主页均为输出板内模块。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：深色紫蓝落地页，含数据、策略和火箭插画。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
柴犬茶饮品牌十八模块设计板，线稿、表情及实物应用皆为输出模块。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
GDX宠物品牌标志、网格、应用和配色系统板。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。DERMA CALM护肤网页，瓶子与女性主视觉；完整JSON定义布局及人物。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：NEX SKIN护肤网页，人物、瓶身与按钮布局。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
CLEAR RESET 护肤网页首屏，人物、两件产品及统计卡在成品内。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
粉白护肤网站横幅，模特、滴管瓶和功能文字。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。花纹裙、围巾、包袋与花样色片目录；pattern由文本描述，不要求另附纹样图。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：游乐园烟花与人物、巨幅日文标题和优惠区。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
清风茶瓶装饮料海报，绿叶水花、价格和文字明确。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
草莓与兔耳女孩的多尺寸广告套图。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。粉发女仆角色的官方周边目录；服装、头像及商品网格由文案给出。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：桌面积木房屋、人物及包装盒。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
LUMIERE 金盖面霜广告，丝绸及大理石底座明确。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
两位男性在短视频直播间PK的界面，与T-800淘宝商品详情prompt主题不符。图片可认作直播设计输出，但不能认作该机器人详情提示词的对应样例。
...
已实际看图并阅读全文。单独看原图确认是不知火舞小红书主页，含笔记和粉丝数据；完整prompt却要求T-800淘宝商品详情和三视图，主题与界面类型均不符，关联仍需复核。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
已查看原图：教室《出师表》黑板与讲台。完整归档prompt要求T-800机器人淘宝详情及三视图，画面主题完全不对应；无法确认当前图为该指令结果或其输入，需修正来源图文配对。
...
T-800 商品详情页，三视图与场景小图属于完整输出页面。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
男性主播和SPACEX火星场景的带货界面。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。TOKYO HIGHBALL罐、柠檬冰饮与海滩背景；完整文字规定产品及文案，无指定包装参考。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：护肤、意面、旅行、任务应用四格广告。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
