...
粉色上衣女性便利店人像，未见独立输入需求；姿势道具与 prompt 有细节差异但资料主题一致。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
橙色圆形背衬、背带裤女性坐姿的铅笔风插画。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。SINGAPORE大字内嵌建筑的旅行海报；CITY\_NAME文字模板，无输入图。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：海龟、珊瑚、浮潜者及大堡礁旅行标题。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
DAEJEON 水彩街景旅行海报，咖啡店及行人场景与文本对应。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
日系街道上白色毛绒外套女性回眸。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。拱门旁情侣层叠纸雕；JSON给出材质风格和角色比例，无指定情侣原照。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：数码相机LCD内的女性照片与时间曝光UI。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
红底巨型红宝石项链与微缩都市广告，完整文字场景输出。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
银发赛博女孩正侧背、头像、配件与色板设定图。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。实拍风笔记本屏幕含Notes和FaceTime男性窗口；完整prompt要求制作这种照片，屏幕缩略图不是另行输入。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：夜晚森林巨型橙色帐篷、人物及WILDCAMP文字。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
鲜艳粉紫发廊插画，女子理发与植物装饰明确。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
生菜、莎莎酱、芝士、肉与塔可壳垂直分层图。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
已实际看图并阅读全文。黑白N标记的镜面马赛克立体App图标；品牌名称为文本槽，无指定Logo文件。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：灰衣墨镜男子的折纸多边形肖像。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
MODERN METRO 工程信息图，地铁及技术模块皆为输出。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
飞行夹克男性在战机与MISSION START字样的城市街景中；exact face未说明对应何张脸，独立身份输入不明。保留待复核，需说明exact face对应的是通用可替换人物还是特定已缺原图。
...
已实际看图并阅读全文。四款腕表、组件和说明的2×2技术板；伪代码prompt是文字渲染说明，无必需附件。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
实际查看：烛光侧照的旗袍女性与深暗背景。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。
...
夕阳海滩白裙成年女子人像，主题和场景文字已给定。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
深色工业企业画册封面、跨页和全册预览；上传公司资料是可选分支。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
