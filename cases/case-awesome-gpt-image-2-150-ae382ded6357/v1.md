...
检索状态：`confirmed`
检索标题：TOKYO HIGHBALL 海滩饮品广告
检索描述：产品广告场景：TOKYO HIGHBALL 罐装饮品、柠檬冰饮和海滩背景，文案与产品由 prompt 直接规定。
检索别名：高波球饮品广告、柠檬冰饮产品图、海滩饮品 KV
检索关键词：TOKYO HIGHBALL、饮品广告、柠檬冰饮、海滩、产品摄影
有效标签：{"categories": ["商品与电商"], "scenes": ["食品饮品", "海滩", "商业"], "styles": ["商品", "写实"]}
