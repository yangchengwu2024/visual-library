...
复核说明：粉色上衣女性便利店人像，未见独立输入需求；姿势道具与 prompt 有细节差异但资料主题一致。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
角色依据：粉色上衣女性便利店人像，未见独立输入需求；姿势道具与 prompt 有细节差异但资料主题一致
