...
复核说明：Paris 黑色旅行涂鸦配少量蓝色，地点为可替换文本。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。

## 检索说明

检索状态：`confirmed`
检索标题：黑色线稿与单一蓝色点缀的旅行手账插画
检索描述：编辑式旅行手账插画：黑色马克笔线稿、宽松留白和单一蓝色点缀，地点和地标以可替换文本表达。
检索别名：单色旅行手账、黑色马克笔旅行插画、蓝色点缀涂鸦
检索关键词：旅行手账、黑色线稿、马克笔、蓝色点缀、编辑插画、留白
有效标签：{"categories": ["插画与艺术"], "scenes": ["旅行", "城市"], "styles": ["插画", "手绘", "编辑"], "techniques": ["linework", "limited palette"]}
...
角色依据：Paris 黑色旅行涂鸦配少量蓝色，地点为可替换文本
