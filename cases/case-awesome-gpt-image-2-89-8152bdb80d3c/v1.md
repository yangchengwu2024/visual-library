...
案例编号：`case-awesome-gpt-image-2-89-8152bdb80d3c` · 版本：`v1`

版本说明：首次收录

资料类型：案例 · 复核状态：已复核

复核说明：文明螺旋塔与人类简史标题的概念海报；主题可替换，样图采用人类历史而非默认帝王排名。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
角色依据：文明螺旋塔与人类简史标题的概念海报；主题可替换，样图采用人类历史而非默认帝王排名

![案例图片 1](../../images/8c0bc5af8b5daf8723d6eeb7951f6c8a106c12e10939cf92ae24772da259b4fb.jpg)
