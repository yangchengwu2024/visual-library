...
复核说明：褶皱纸团到椅子形态、工程视图及成品的概念研发板；image of crumpled paper描述观察对象，未指定上传来源。已阅读全文并查看样图，图片为结果示例；未发现必须补充某一指定输入图片。
...
角色依据：褶皱纸团到椅子形态、工程视图及成品的概念研发板；image of crumpled paper描述观察对象，未指定上传来源
