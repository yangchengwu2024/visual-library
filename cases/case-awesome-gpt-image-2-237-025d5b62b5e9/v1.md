...
复核说明：已实际看图并阅读全文。蓝天水花柑橘PET汽水广告；文案要求研究2025广告设计，未指定图片输入，本次不作外部研究真实性核验。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
角色依据：蓝天水花柑橘PET汽水广告；文案要求研究2025广告设计，未指定图片输入，本次不作外部研究真实性核验。
