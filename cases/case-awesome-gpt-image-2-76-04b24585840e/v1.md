...
案例编号：`case-awesome-gpt-image-2-76-04b24585840e` · 版本：`v1`

版本说明：首次收录

资料类型：案例 · 复核状态：已复核

复核说明：实际查看：英国短毛猫百科卡，含细节与分类模块。已通读完整归档指令；图像为该创作方向的结果样例，文本未要求某张特定外部原图。含可替换主题、人物或参数，样例可采用不同填充值；不把通用占位符视为缺少指定图片。
...
角色依据：英国短毛猫百科卡，含细节与分类模块；完整指令对应的成品样例展示

![案例图片 1](../../images/a486424a97f4bdf25082e3ea5b811d13e26ae9bdbfeefde3d1072e5a13ca322a.jpg)
