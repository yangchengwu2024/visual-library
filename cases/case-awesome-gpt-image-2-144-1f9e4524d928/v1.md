...
复核说明：LUMIERE 金盖面霜广告，丝绸及大理石底座明确。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。

## 检索说明

检索状态：`confirmed`
检索标题：LUMIERE 金盖面霜与丝绸大理石底座广告
检索描述：高级美妆产品广告：LUMIERE 金盖面霜置于丝绸和大理石底座上，强调材质、光泽与品牌氛围。
检索别名：面霜产品广告、丝绸大理石商品图、美妆品牌 KV
检索关键词：LUMIERE、面霜、美妆、丝绸、大理石、金盖
有效标签：{"categories": ["商品与电商"], "materials": ["marble", "glass", "fabric", "silk"], "scenes": ["商业", "美妆"], "styles": ["商品", "品牌", "海报"]}
...
角色依据：LUMIERE 金盖面霜广告，丝绸及大理石底座明确
