...
复核说明：原图标题为中国社会演进史，prompt 指定 Western Art Development，图文主题冲突。已实际看样图并阅读完整 prompt；复核资料关系与输入条件，不代表生成复现或逐项事实准确性验收。
...
角色依据：原图标题为中国社会演进史，prompt 指定 Western Art Development，图文主题冲突
