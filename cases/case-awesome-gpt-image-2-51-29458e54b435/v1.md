...
案例编号：`case-awesome-gpt-image-2-51-29458e54b435` · 版本：`v1`

版本说明：首次收录

资料类型：案例 · 复核状态：已复核

复核说明：已实际看图并阅读全文。七日女性穿搭表及局部缩略图；衣物与分栏由JSON指定，缩略图属于输出信息。 本次核对资料关系、图片角色和输入条件，不代表身份、事实或逐像素生成正确性验收。
...
角色依据：七日女性穿搭表及局部缩略图；衣物与分栏由JSON指定，缩略图属于输出信息。

![案例图片 1](../../images/5bc3fce7ab2e021ab87ff089a03343e70bead7241b33b851b6768706010ae374.jpg)
