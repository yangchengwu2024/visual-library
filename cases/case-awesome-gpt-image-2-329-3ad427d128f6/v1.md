...
复核说明：实际查看皮甲女战士及燃翼巨鸟结果图。完整英文prompt含use image for face reference，中文未提该句；属于可自行提供人脸照片的替换模板，未指认必须找回的特定原照片。使用英文版仍需提供自选参考照片；本次不判断人脸一致性。
...
角色依据：皮甲女战士与燃烧双翼巨鸟的森林场景；完整指令对应的成品样例展示
